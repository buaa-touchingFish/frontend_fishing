<template>
    <div v-for="(name,index) in starClassNames" class="recommend" :class="[{recommendStar:!recommendShow[index]},name]" @mouseenter="recommendShow[index] = true" @mouseleave="recommendShow[index] = false">
        <!-- <div class="recommendTitle" v-show="recommendShow[index]">
            题目很长很长很长很长很长很长很长很长很长很长
        </div>
